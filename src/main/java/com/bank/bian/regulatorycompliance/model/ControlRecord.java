package com.bank.bian.regulatorycompliance.model;
...
/**
 * The BIAN control record for this service domain: "Compliance Requirement Management Plan".
 *
 ...
 * to its asset type (Compliance Requirement). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Compliance Requirement Management Plan";
